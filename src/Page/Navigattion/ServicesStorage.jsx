...
const ServicesStorage = () => {
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      {/* GIỚI THIỆU DỊCH VỤ */}
      <Section title="Giới thiệu dịch vụ Tiximax ký gửi kho">
        <>
          <p>
      ...
      <Section title="Ký gửi kho quốc tế tại Mỹ, Nhật, Hàn, Indonesia">
        <>
          <p>
      ...
      <Section title="Cho mượn địa chỉ & cho mượn kho – khác nhau thế nào?">
        <>
      ...
      {/* QUY TRÌNH */}
      <Section title="Quy trình sử dụng dịch vụ Tiximax ký gửi kho">
        <>
      ...
      {/* ĐỐI TƯỢNG PHÙ HỢP */}
      <Section title="Ai nên sử dụng dịch vụ Tiximax ký gửi kho?">
        <>
          <p>Dịch vụ ký gửi kho Tiximax phù hợp với:</p>
          <ul className="list-disc pl-6 space-y-1.5">
            <li>
              Khách hàng cá nhân muốn tự mua hàng Mỹ, Nhật, Hàn, Indonesia mà
      ...
      {/* LỢI ÍCH */}
      <Section title="Lợi ích khi sử dụng Tiximax ký gửi kho">
        <>
          <ul className="list-disc pl-6 space-y-1.5">
            <li>
      ...
      {/* FAQ */}
      <Section title="Câu hỏi thường gặp về Tiximax ký gửi kho">
        <>
